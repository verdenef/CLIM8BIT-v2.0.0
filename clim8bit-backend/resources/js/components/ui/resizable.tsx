...
// The library exports these at runtime, but the type definitions don't expose them cleanly,
// so we alias them through `any` to keep TypeScript happy while preserving behavior.
